...
def mutualisation_eti31():
    path_eti31 = "/label_adresse_commentaire_eti31_bis.xlsx"
    path_dossier = "/Projet 2 - Distance au PB/traitement/eti31/fichiers_calcul"
    path_dossier_final = "/Projet 2 - Distance au PB/traitement/eti31/"
    ...
    for i in range(len(liste_path)):
        ...
        df_final = df_final.drop_na(axis=0)
...
def creation_scaler():
    ...
    dump(scaler, '/Projet 2 - Distance au PB/traitement/scaler2.joblib')
...
def normalisation_for_all(df, exceptions):
    ...
    scaler = load('/Projet 2 - Distance au PB/traitement/scaler2.joblib')
...
def complet(chemin_fichier=None, chemin_dossier=None):
    ...
    if df is not None and dossier is not None:
