...
def modele_arbre_decision():
    ...
    joblib.dump(arbre,
                "/Ancien/commentaires/modelisation/arbre_decision.joblib")
...
def modele_arbre_boosting():
    ...
    joblib.dump(arbre,
                "/Ancien/commentaires/modelisation/arbre_boosting.joblib")
...
def modele_nn():
    ...
    joblib.dump(neigh,
                "/Ancien/commentaires/modelisation/nearest_neighbors.joblib")
...
def modele_regression_logistique():
    ...
    joblib.dump(lgr,
                "/Ancien/commentaires/modelisation/logistic_regression.joblib")
...
def modele_svm():
    ...
    joblib.dump(clf,
                "/Ancien/commentaires/modelisation/svm.joblib")
...
def modele_nb():
    ...
    joblib.dump(mod,
                "/Ancien/commentaires/modelisation/naive_bayes.joblib")
