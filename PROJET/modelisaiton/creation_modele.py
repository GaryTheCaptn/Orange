...
eti31 = pd.read_excel("C:/Users/SPML0410/Documents/MachineLearning2/projet/df_final.xlsx")
...
def pred_seuil(df, modele_name, seuil=0.5):
    ...
    """
    modele = joblib.load(
        "C:/Users/SPML0410/Documents/MachineLearning2/projet/modelisation/modeles/" + modele_name + ".joblib")
